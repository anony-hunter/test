...
|<p>+ setAge( Age : int)</p><p>+ setName(name : String)</p><p>+ getUserName(userName : String)</p><p>+ getPassword(password : String)</p><p>+ getSchedule()</p><p>+ getProgress()</p><p>+ getAppBlock()</p><p>+ enableParentMode()</p><p>+ setParent()</p><p>+setTotalParents()</p><p>+ getRemainingTime()</p>|
...
1 .. \* Uses 1 .. \*![](Aspose.Words.97d41314-963e-4e96-a832-0646e2d45041.001.png)![](Aspose.Words.97d41314-963e-4e96-a832-0646e2d45041.002.png)

|**Timer**|
| - |
|- remainingTime : int|
|<p>+ startTime()</p><p>+ stopTime()</p><p>+ timeDiff()</p>|
has a![](Aspose.Words.97d41314-963e-4e96-a832-0646e2d45041.003.png)

Child of 

0..\*![](Aspose.Words.97d41314-963e-4e96-a832-0646e2d45041.004.png)
...
has a make/view![](Aspose.Words.97d41314-963e-4e96-a832-0646e2d45041.005.png)
